...
function kalpOlustur() {
    ...
    const sure = 5 + Math.random() * 5;
    kalp.style.animationDuration = sure + "s";
...
function devamEt() {
    sayfa++;
    if (sayfa === 1) {
        document.getElementById("baslik").innerHTML = "hoşgeldin...";
...
function superr() {
    ...
    document.getElementById("butonlar").innerHTML = `
        <button onclick="tmmSus()">sen olmadan geçen günlerim çok huzurlu</button>
        <button onclick="tmmSus()">iyiyim işte mal</button>
    `;
}
function kotu() {
    document.getElementById("baslik").innerHTML = "niye??????";
    document.getElementById("butonlar").innerHTML = `
        ...
        <button onclick="tmmSus()">senle ilgisi yok mal her şeyi üstüne alınma</button>
    `;
}
function tmmSus() {
...
function surpriz(yazi) {
    /*
     * Eski kodda burada JavaScript bozuluyordu.
     * jumpscare.gif ve jumpscare.mp3 dosya adıyla
     * getElementById kullanılmaya çalışılmıştı.
     */
...
function sevgiSayfasi() {
    document.getElementById("sevgiSayfasi").style.display = "flex";
}
/* -------------------- */
/* OKUMUYORUM */
/* -------------------- */
function okumuyorum() {
    document.getElementById("sevgiSayfasi").style.display = "none";
    document.getElementById("okumuyorumSayfasi").style.display = "flex";
}
/* -------------------- */
/* ZORLA BARIŞTIK */
/* -------------------- */
function zorlaSayfasi() {
    document.getElementById("zorlaSayfasi").style.display = "flex";
    hayirSayisi = 0;
    const evet = document.getElementById("evetButonu");
    evet.style.position = "";
    evet.style.inset = "";
    evet.style.width = "";
    evet.style.height = "";
...
function hayirBuyut() {
    ...
    const evet = document.getElementById("evetButonu");
    if (hayirSayisi < 5) {
        const buyume = 1 + (hayirSayisi * 0.8);
        evet.style.transform = `scale(${buyume})`;
    }
    else {
        ...
        evet.style.fontSize = "clamp(40px, 10vw, 100px)";
        evet.innerHTML = "EVET 💗";
    }
}
function zorlaEvet() {
    document.getElementById("zorlaSayfasi").style.display = "none";
    sevgiSayfasi();
}
/* -------------------- */
/* FİNAL */
...
function final() {
    document.getElementById("sevgiSayfasi").style.display = "none";
    document.getElementById("okumuyorumSayfasi").style.display = "none";
    document.getElementById("zorlaSayfasi").style.display = "none";
    document.getElementById("baslik").innerHTML =
